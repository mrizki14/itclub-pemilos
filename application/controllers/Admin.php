 <?php
	class Admin extends CI_Controller
	{
		...
		public function daftarhadir()
		{
			...
			$data['datakelas']	= $this->Admin_Model->datakelas();
			$config['base_url'] = site_url('admin/daftarhadir');
			...
			$data['idsekolah']	= $this->Admin_Model->idsekolah();
			$data['daftarhadir'] = $this->Admin_Model->daftarhadir($config["per_page"], $data['page']);
		...
		public function cetakdaftarhadir()
		{
			...
			$pdf->Cell(190, 7, 'DAFTAR HADIR KEGIATAN PEMILIHAN', 0, 1, 'C');
			$pdf->Cell(10, 7, '', 0, 1);
		...
		public function laporan()
		{
			...
			$pdf->SetFont('Arial', 'B', 16);
			//HEADER LAPORAN
			$pdf->Cell(290, 7, 'LAPORAN PELAKSANAAN KEGIATAN', 0, 1, 'C');
