    ...
    <?php if (!isset($no_visible_elements) || !$no_visible_elements) { ?>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="navbar-inner">
                ...
                <span><img class="logo-it" src="<?php echo base_url(); ?>asset/img/favicon.png" alt="it_club" style="height:auto; width:70px; position: relative; bottom: 15px;" >
                <b>ITCLUB-SMKN 5 BANDUNG</b></span>
                </a>
