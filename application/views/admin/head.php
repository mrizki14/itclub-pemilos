...
<head>
    <meta charset="utf-8">
    <title><?php echo $this->config->item('nama_aplikasi') . " &copy; " . $this->config->item('tahun_kegiatan'); ?></title>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>asset/img/favicon.svg">
</head>